...
import { FloatingChatButton } from '../../src/features/chat/components/FloatingChatButton';
  ...
  return (
    <>
      ...
      >
        ...
        />
        {/* Pestaña soporte oculta de la barra de pestañas pero accesible para navegación */}
        <Tabs.Screen
          name="soporte"
          options={{
            href: null, // Oculta este tab de la barra de navegación inferior
            title: 'Soporte',
            headerTitle: 'Canal de Soporte',
          }}
        />
      </Tabs>
